...
function M.setup()
  ...
  local lazypath = M.bundlepath .. "/lazy.nvim"
...
function M.setup_plugins()
  --[[ Import plugins by spec ]]
  local spec = {  -- See the lua/plugins/example.lua for plugin's spec writing guide
...
--[[ Reference for the lazy.nvim default options: ]]
--[[ ==> Begin:
opts = {  -- using '#config.*' to refer to these options elsewhere
