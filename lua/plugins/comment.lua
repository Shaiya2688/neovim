return {
  ...
  -- Provides many different commenting operations and styles
  {
    ...
    init = function()
      ...
      vim.g.NERDToggleCheckAllLines = 1     -- Enable NERDCommenterToggle to check all selected lines instead of topmost selected line is commented or not (i.e. commented-out means that all selected lines are commented)
    ...
    config = function()
      vim.keymap.set({ 'n', 'x' }, '<Leader>cc', "<Plug>NERDCommenterComment",      { desc = "Comment Current Line or Selected Texts" })
      vim.keymap.set({ 'n', 'x' }, '<Leader>cy', "<Plug>NERDCommenterYank",         { desc = "Comment Current Line or Selected Texts (Yank First)" })
      vim.keymap.set({ 'n', 'x' }, '<Leader>cn', "<Plug>NERDCommenterNested",       { desc = "Comment Current Line or Selected Texts (Nested)" })
      ...
      vim.keymap.set({ 'n', 'x' }, '<Leader>ci', "<Plug>NERDCommenterInvert",       { desc = "Toggle Comments of Current Line or Selected Lines (Each Line Individually)" })
      vim.keymap.set({ 'n', 'x' }, '<Leader>c<Space>', "<Plug>NERDCommenterToggle", { desc = "Toggle Comments of Current Line or Selected Lines" })
